/*
  # Phase 1: Database Schema Updates for SRS Compliance
  
  ## Summary
  This migration adds all missing database fields and tables required for Phase 1 SRS compliance.
  
  ## 1. New Tables
  
  ### cart_items
  - Stores shopping cart items for users
  - Allows users to add multiple courses before checkout
  ...
  - Supports SMS/OTP confirmation flow
  ...
  - Commission rates, currencies, file limits
  
  ## 2. Modified Tables
  
  ### institutes table additions:
  - logo_url: Institute logo image
  - banner_url: Institute banner image
  - customer_care_email: Separate customer support email
  - customer_care_phone: Separate customer support phone
  - admin_contact_person: Admin contact name
  - house_number: Detailed address component
  - street_name: Detailed address component
  - landmark: Detailed address component
  - country: Country field
  - postcode: Postal code field
  - license_number: License/Resolution number
  ...
  - country: Country field
  - postcode: Postal code field
  - position: Position/rank dropdown value
  - education_details: Maritime qualifications
  ...
  - course_code: Generated unique code (BTSTCODE + INST + 0001)
  - instructor_name: Name of the instructor
  - thumbnail_url: Course thumbnail image
  - category: Course category (from NAMAC)
  - target_audience: Target audience description
  - entry_requirements: Entry requirements text
  - course_overview: Detailed overview
  - additional_notes: Additional notes
  - currency: Currency for fees (INR, USD, EUR, AED)
  - approval_date: Date when course was approved
  - approved_by: Admin who approved the course
  
  ### batches table additions:
  - instructor_name: Instructor for this batch
  ...
  - Performance optimization for cart, notifications
*/
