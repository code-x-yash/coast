        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">SeaLearn</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Professional maritime education platform for merchant navy personnel worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>support@sealearn.com</span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>123 Maritime Way, Harbor City, HC 12345</span>
              </li>
            </ul>
          </div>
        </div>
